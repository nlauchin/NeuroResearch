...
netParams.popParams['CSTR_pop'] = {'cellType': 'CSTR','numCells':2, 'cellModel': 'HH'}

cellRule = {'conds': {'cellType':'CSTR', 'cellModel':'HH'}, 'secs': {}}
soma = {'geom':{}, 'mechs':{}}
soma['geom'] = {'diam': 44.3, 'L': 23.9, 'Ra':123.0, 'pt3d': []}
...
netParams.cellParams['CSTR_HH'] = cellRule
...
netParams.stimTargetParams['Input_1->CSTR'] = {'source': 'Input_1', 'sec':'soma', 'loc':0.5, 'conds': {'popLabel': 'CSTR_pop'}}
