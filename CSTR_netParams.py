...
netParams.stimTargetParams['Input_3->IT_full_BS1578'] = {'source': 'Input_3', 'sec':'soma_0', 'loc':0.5, 'conds': {'pop': 'ITpop'}}

# Netstim input
netParams.stimSourceParams['Input_1'] = {'type': 'NetStim', 'rate': 10, 'noise': 0.5, 'start': 100}
netParams.stimTargetParams['Input_1->IT_full_BS1578'] = {'source': 'Input_1', 'sec':'soma_0', 'loc': 0.5, 'weight': 0.2, 
